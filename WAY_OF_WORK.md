# Draw.io Skill Package — WAY OF WORK

## 7-Phase Research-First Methodology

This methodology is proven across the Blender (73 skills), ERPNext (28 skills), and Open-Agents (28 skills) packages.

---

### Phase 1: Raw Masterplan
**Goal:** Define scope and preliminary skill inventory.
- Map the Draw.io technology landscape
- Identify all diagram types, XML constructs, and integration points
...
- Sources: official docs, source code (Apache 2.0), community resources
- Research documents:
  - `vooronderzoek-drawio-xml.md` — mxGraph XML format
  - `vooronderzoek-drawio-styles.md` — style system
  - `vooronderzoek-drawio-diagrams.md` — diagram types
  - `vooronderzoek-drawio-integration.md` — CSV, Mermaid, templates, export
...
- Focus on exact XML patterns, style properties, shape catalogs
...
- 3-5 agents per batch, parallel execution
...
- Run quick_validate.py / batch_validate.py across all skills
- Structural: frontmatter, line count, references
- Content: deterministic language, English-only
- Functional: test diagram generation using skills
...
```
skills/drawio/{category}/{drawio-{category}-{topic}}/
├── SKILL.md              # Main skill (< 500 lines, YAML frontmatter)
└── references/
    ├── methods.md         # API/XML methods and attributes
...
## Essential Patterns
[Core XML/style patterns with examples]
